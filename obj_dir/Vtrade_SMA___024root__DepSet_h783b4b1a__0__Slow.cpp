...
VL_ATTR_COLD void Vtrade_SMA___024root___ctor_var_reset(Vtrade_SMA___024root* vlSelf) {
    ...
    vlSelf->trade_SMA__DOT__SMA_preprocessor_mine__DOT__rom_dout = VL_RAND_RESET_I(8);
    vlSelf->trade_SMA__DOT__SMA_preprocessor_mine__DOT__rom_addr = VL_RAND_RESET_I(16);
    for (int __Vi0=0; __Vi0<65536; ++__Vi0) {
        vlSelf->trade_SMA__DOT__SMA_preprocessor_mine__DOT__my_rom__DOT__rom_array[__Vi0] = VL_RAND_RESET_I(8);
    }
    for (int __Vi0=0; __Vi0<5; ++__Vi0) {
        vlSelf->trade_SMA__DOT__SMA_preprocessor_mine__DOT__win_5__DOT__Q[__Vi0] = VL_RAND_RESET_I(8);
    }
    vlSelf->trade_SMA__DOT__SMA_preprocessor_mine__DOT__win_5__DOT__sum = VL_RAND_RESET_I(32);
    for (int __Vi0=0; __Vi0<10; ++__Vi0) {
        vlSelf->trade_SMA__DOT__SMA_preprocessor_mine__DOT__win_10__DOT__Q[__Vi0] = VL_RAND_RESET_I(8);
    }
    vlSelf->trade_SMA__DOT__SMA_preprocessor_mine__DOT__win_10__DOT__sum = VL_RAND_RESET_I(32);
    for (int __Vi0=0; __Vi0<20; ++__Vi0) {
        vlSelf->trade_SMA__DOT__SMA_preprocessor_mine__DOT__win_20__DOT__Q[__Vi0] = VL_RAND_RESET_I(8);
    }
    vlSelf->trade_SMA__DOT__SMA_preprocessor_mine__DOT__win_20__DOT__sum = VL_RAND_RESET_I(32);
    for (int __Vi0=0; __Vi0<50; ++__Vi0) {
        vlSelf->trade_SMA__DOT__SMA_preprocessor_mine__DOT__win_50__DOT__Q[__Vi0] = VL_RAND_RESET_I(8);
    }
    vlSelf->trade_SMA__DOT__SMA_preprocessor_mine__DOT__win_50__DOT__sum = VL_RAND_RESET_I(32);
    for (int __Vi0=0; __Vi0<100; ++__Vi0) {
        vlSelf->trade_SMA__DOT__SMA_preprocessor_mine__DOT__win_100__DOT__Q[__Vi0] = VL_RAND_RESET_I(8);
    }
    vlSelf->trade_SMA__DOT__SMA_preprocessor_mine__DOT__win_100__DOT__sum = VL_RAND_RESET_I(32);
    for (int __Vi0=0; __Vi0<200; ++__Vi0) {
        vlSelf->trade_SMA__DOT__SMA_preprocessor_mine__DOT__win_200__DOT__Q[__Vi0] = VL_RAND_RESET_I(8);
    }
    vlSelf->trade_SMA__DOT__SMA_preprocessor_mine__DOT__win_200__DOT__sum = VL_RAND_RESET_I(32);
}
