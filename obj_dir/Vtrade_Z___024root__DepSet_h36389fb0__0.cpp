...
VL_INLINE_OPT void Vtrade_Z___024root___sequent__TOP__0(Vtrade_Z___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtrade_Z__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtrade_Z___024root___sequent__TOP__0\n"); );
    // Body
...
VL_INLINE_OPT void Vtrade_Z___024root___sequent__TOP__1(Vtrade_Z___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtrade_Z__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtrade_Z___024root___sequent__TOP__1\n"); );
    // Init
...
VL_INLINE_OPT void Vtrade_Z___024root___sequent__TOP__2(Vtrade_Z___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtrade_Z__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtrade_Z___024root___sequent__TOP__2\n"); );
    // Body
    vlSelf->trade_Z__DOT__Preprocessor_mine__DOT__rom_addr 
        = vlSelf->__Vdly__trade_Z__DOT__Preprocessor_mine__DOT__rom_addr;
}
...
void Vtrade_Z___024root___eval(Vtrade_Z___024root* vlSelf) {
    ...
    if ((((IData)(vlSelf->clk) & (~ (IData)(vlSelf->__Vclklast__TOP__clk))) 
        ...
        Vtrade_Z___024root___sequent__TOP__0(vlSelf);
    }
    if (((IData)(vlSelf->clk) & (~ (IData)(vlSelf->__Vclklast__TOP__clk)))) {
        Vtrade_Z___024root___sequent__TOP__1(vlSelf);
    }
    if ((((IData)(vlSelf->clk) & (~ (IData)(vlSelf->__Vclklast__TOP__clk))) 
         | ((IData)(vlSelf->rst) & (~ (IData)(vlSelf->__Vclklast__TOP__rst))))) {
        Vtrade_Z___024root___sequent__TOP__2(vlSelf);
    }
    // Final
